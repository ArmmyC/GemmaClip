      ...
      <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
        <div className="space-y-6">
          <div className={`relative overflow-hidden rounded-xl border border-border ${posterGrad} aspect-video`}>
            <div className="absolute inset-0 dot-paper opacity-10" />
            <div className="absolute inset-0 flex items-center justify-center">
              <button className="flex h-16 w-16 items-center justify-center rounded-full bg-paper/90 text-ink shadow-lg transition hover:scale-105">
          ...
          <ConfigSection
            ...
            actions={
              <Button onClick={runPreset} disabled={busy} size="sm" className="gap-1.5">
