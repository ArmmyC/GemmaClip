// Typed models for the GemmaClip mock API. These mirror the shape a future
// FastAPI backend would return, so the UI can be swapped over without churn.
...
export interface StructuredEvidence {
  ...
  styleHooks: string[];
  audio: {
    status: "not-analyzed" | "analyzed" | "no-audio-stream";
    speechPresent: boolean;
    language: string | null;
    transcript: string | null;
    visualConsistency: "consistent" | "mixed" | "inconsistent" | "n/a";
