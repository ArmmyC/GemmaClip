    ...
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
        ...
        <div className="space-y-4">
          <AudioWaveform segment={run.audio.segment} durationSec={run.video.durationSec} />
          ...
          <div className="flex items-center gap-3 rounded-xl border border-border bg-card p-4">
            <button className="flex h-11 w-11 items-center justify-center rounded-full bg-ink text-paper transition hover:scale-105">
